...
class GaussianModel:
    ...
    def training_setup_sds(self, training_args, lr=1e-3):
        self.percent_dense = training_args.percent_dense
        self.xyz_gradient_accum = torch.zeros((self.get_xyz.shape[0], 1), device="cuda")
        self.denom = torch.zeros((self.get_xyz.shape[0], 1), device="cuda")
        l = [
            {'params': [self._xyz], 'lr': lr * self.spatial_lr_scale, "name": "xyz"},
            ...
            {'params': [self._distill_features], 'lr': lr, "name": "distill_features"},
        ]
